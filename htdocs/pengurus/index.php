<div class="container-fluid">
  ...
  <p class="mt-5">
    ...
    <a href="<?= base_url ?>/pengurus/hapusAll" class="btn btn-danger btn-sm mb-2 float-right mr-2">Hapus Semua</a>
  </p>
      ...
      while ($data = mysqli_fetch_array($sql_query)) : ?>
        <tr>
          ...
          <th class="text-center">
            <a href="<?= base_url ?>/pengurus/hapus/<?= $data['nis'] ?>" class="badge badge-danger mr-1">Hapus</a>
          </th>
        </tr>
      <?php endwhile ?>
    </tbody>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST" action="<?= base_url ?>/pengurus/simpan">
            <p class="">NIS</br>

<div class="container-fluid">
    ...
    <div class="row justify-content-center ml-2 mr-2">
        <div class="col-lg-6">
            ...
            ?>
            <form method="POST" action="<?= base_url ?>/pelanggaran/simpan">
                <p class="">NIS Siswa Yang Melanggar Adalah :</br>
                    <div class="form-group">
                        <input type="text" class="form-control" name="nisPelanggar" id="nisPelanggar" value="<?= $data['nis']; ?>" size="30" readonly />
                    </div>
                </p>

                <p class="">Nama Siswa Tersebut Adalah :</br>
                    <div class="form-group">
                        <input type="text" class="form-control" name="namaPelanggar" id="namaPelanggar" value="<?= $data['nama']; ?>" size="30" readonly />
                    </div>
                </p>

                <p class="">Jenis Kelamin Nya Adalah :</br>
                    <div class="form-group">
                        <input type="text" class="form-control" name="jenisKelamin" id="namaPelanggar" value="<?= $data['jk']; ?>" size="30" readonly />
                    </div>
                </p>

                <p class="">Kelas Siswa Tersebut Adalah :</br>
                    <div class="form-group">
                        <input type="text" class="form-control" name="kelasPelanggar" id="kelasPelanggar" value="<?= $data['kelas']; ?>" size="30" readonly />
                    </div>
                </p>

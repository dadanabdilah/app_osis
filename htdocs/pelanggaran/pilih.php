                ...
                <?php while ($data = mysqli_fetch_array($sql_query)) :
                    ...
                    <tr>
                        ...
                        <th class="text-center">
                            <a href="<?= base_url ?>/pelanggaran/tambah/<?= $data['nis'] ?>" class="btn btn-primary btn-sm">Input Poin</a>
                        </th>
                    </tr>
                <?php endwhile ?>
            <?php endif ?>
